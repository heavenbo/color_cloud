                      ...
                      [&](tbb::blocked_range<int> r)
                      {
                          ...
                          for (int i = r.begin(); i < r.end(); ++i)
                          {
                              ...
                              if (point2d.x() < width && point2d.y() < height)
                              {
                                  ...
                                  colorPoint.b = *(cam_left_ + (int)point2d.y() * 640 * 3 + (int)point2d.x() * 3);
                                  colorPoint.g = *(cam_left_ + (int)point2d.y() * 640 * 3 + (int)point2d.x() * 3 + 1);
                                  colorPoint.r = *(cam_left_ + (int)point2d.y() * 640 * 3 + (int)point2d.x() * 3 + 2);
